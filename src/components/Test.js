...
export default function Test(props) {
	...
	const fixedData = [
		new Question('Gosto de Matemática 🧮📐', 'muito/pouco', 3, 5, 5, 3),
		new Question('Lido bem com Pessoas 🏬', 'muito/pouco', 5, 2, 2, 4),
		new Question('Curto robôs 🤖', 'muito/pouco', 2, 5, 5, 3),
		new Question('Me identifico com as Ciências Exatas 🔭🔬', 'muito/pouco', 4, 5, 5, 3),
		new Question('Gosto de cubo-mágico, xadrez, damas e outros jogos ♟️', 'muito/pouco', 4, 5, 3, 2),
		new Question('Gostava de brinquedos de construção na infância, como Lego 🧰', 'muito/pouco', 2, 4, 3, 5),
		new Question('Me identifico as Ciências Humanas 📖⏳', 'muito/pouco', 5, 2, 2, 5),
		new Question('Gosto de videogames 🎮', 'muito/pouco', 2, 5, 4, 2),
		new Question('Tenho senso de liderança 📈', 'sim/nao', 5, 3, 2, 4),
		new Question('Prefiro fazer trabalhos sozinho(a) 🧍', 'sim/nao', 1, 5, 4, 2),
